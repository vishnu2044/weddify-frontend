    ...
    <div className="relative max-w-7xl mx-auto">
      <div className="max-w-lg mx-auto rounded-lg shadow-lg overflow-hidden lg:max-w-none lg:flex">
        <div className="flex-1 px-6 py-8 lg:p-12 bg-gray-600">
          <h3 className="text-2xl font-extrabold text-white sm:text-3xl">Yearly Plan</h3>
        ...
        <div className="py-8 px-6 text-center lg:flex-shrink-0 lg:flex lg:flex-col lg:justify-center lg:p-12 bg-gray-700">
          ...
          <div className="mt-4 flex items-center justify-center text-4xl font-extrabold text-white">
            <span>₹{premiumPlan.yearly_price-1}</span> <span className='font-normal text-2xl'>/year</span>
          </div>
          <div className="mt-4 flex items-center justify-center text-xl font-extrabold text-white">
            <span>₹{premiumPlan.yearly_plan_month_rate-1}</span> <span className='font-normal text-xl'>/month</span>
          </div>
          <div className="mt-6">
            <div className="rounded-md shadow">
              <p  
                onClick={YearlyPlanConfirmPopUp}  
