...
const MenList = ({adminPanelData, userBlockManagement}) => {
    const navigate = useNavigate()
  return (
    <div>
        <div class="mx-6 shadow-md rounded-md bg-[#C9F0C9]">
            <div class="m-6 pt-2">
                <div class="flex flex-wrap -mx-6">
                    <div class="w-full px-6 ">
                        <div class="flex items-center px-3 py-6 shadow-md rounded-md bg-[#e5ffe5]">
                        </div>
                    </div>
                </div>
            </div>
