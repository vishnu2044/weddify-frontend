...
const PremiumPlans = ({openEditPopup}) => {
  return (
      ...
      <div class="divide-y bg-[#C9C9F0] divide-gray-200 rounded-lg border border-gray-200 shadow-md">
        <div class="p-6">
          ...
          <p class="my-4 text-4xl font-bold tracking-tight text-gray-900">
            ₹<span id="standardPlanPrice">499</span><span class="text-base font-medium text-gray-500 ml-1">/month</span>
          </p>
        </div>
      ...
      <div class="divide-y bg-[#C9C9F0] divide-gray-200 rounded-lg border-2 shadow-md">
        <div class="px-6 py-4">
          ...
          <p class="my-4 text-3xl font-bold tracking-tight text-gray-900">
            ₹<span id="standardPlanPrice">4999</span><span class="text-base font-medium text-gray-500 ml-1">/month</span>
          </p>
          <p class="my-4 text-2xl font-bold tracking-tight text-[#404080]">
            ₹<span id="standardPlanPrice">417</span><span class="text-base font-medium text-gray-500 ml-1">/month</span>
          </p>
        </div>
