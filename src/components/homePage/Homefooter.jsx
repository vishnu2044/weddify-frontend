...
const Homefooter = () => {
  return (
    <div className="bg-[#375779] p-4 mt-20">
      <h2 className="text-3xl text-white font-extrabold my-3 text-center">Get the app</h2>
      <div className="flex w-full style-flex-col md:flex-row gap-y-4 gap-x-8 sm:items-center md:justify-center">
        <a
          href=""
          target="_blank"
          className="flex items-center justify-center w-full px-5 py-3 text-center shadow-md text-white bg-white rounded-2xl sm:rounded-2xl md:w-auto"
          rel="noreferrer"
        >
          ...
          <div className="flex flex-col ml-2 leading-4 text-left md:ml-3">
            ...
            <span className="text-base font-semibold text-black">App Store</span>
          </div>
        </a>
        ...
        >
          ...
          <div className="flex flex-col ml-2 leading-4 text-left md:ml-3">
            <span className="text-sm text-black">Get it on</span>
            <span className="text-base font-semibold text-black">Play Store</span>
          </div>
        </a>
      </div>
    </div>
