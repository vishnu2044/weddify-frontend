      ...
      <div class="m-auto">
        <div class="rounded-xl bg-white w-auto shadow-xl">
          <div class="p-12 w-auto">
            <div class="space-y-4">
              <h3 class="mb-12 text-lg font-semibold">Do you want to block {matchName} ?</h3>
            </div>


            <div onClick={ManageBlockPopUp} class="mt-3 justify-center flex">

                <button onClick={()=>handleButtonManagement({match_id : matchProfileId, button:'block'})} type='submit' class="group h-12 px-6 border-2 bg-[#fb483b] mx-4  border-gray-300 shadow-md rounded-2xl">
...
export default UnBlockUserAlert